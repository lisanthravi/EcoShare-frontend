...
const EnvironmentHealth = () => {
    ...
    const fetchTips = async () => {
        try {
            const response = await axios.get('http://localhost:5000/api/environment-health');
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:5000/api/environment-health', formData);
    ...
    return (
        <div className='ser-outer'>
         <br></br>
         <br></br>
            <h1>Environment & Health Tips and Projects</h1>
         <br></br>
