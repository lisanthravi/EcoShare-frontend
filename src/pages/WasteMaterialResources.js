...
const WasteMaterialResources = () => {
    ...
    const fetchTips = async () => {
        try {
            const response = await axios.get('http://localhost:5000/api/waste-material-resources');
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:5000/api/waste-material-resources', formData);
    ...
    return (
        <div className='ser-outer'>
             <br></br>
             <br></br>
            <h1>Waste and Material Resources Tips and Projects</h1>
             <br></br>
...
export default WasteMaterialResources;
