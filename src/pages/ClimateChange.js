...
const ClimateChange = () => {
    ...
    const fetchTips = async () => {
        try {
            const response = await axios.get('http://localhost:5000/api/climate-change');
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:5000/api/climate-change', formData);
    ...
    return (
        <div className='ser-outer'>
            <br></br>
            <br></br>
            <h1>Climate Change Tips and Projects</h1>
            <br></br>
