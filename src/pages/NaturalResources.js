...
const NaturalResources = () => {
    ...
    const fetchTips = async () => {
        try {
            const response = await axios.get('http://localhost:5000/api/natural-resources');
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:5000/api/natural-resources', formData);
    ...
    return (
        <div className='ser-outer'>
             <br></br>
             <br></br>
            <h1>Natural Resources Tips and Projects</h1>
             <br></br>
