...
const Biodiversity = () => {
    ...
    const fetchTips = async () => {
        try {
            const response = await axios.get('http://localhost:5000/api/biodiversity');
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:5000/api/biodiversity', formData);
    ...
    return (
        <div className='ser-outer'>
            <br></br>
            <br></br>
            <h1>Biodiversity Tips and Projects</h1>
            <br></br>
